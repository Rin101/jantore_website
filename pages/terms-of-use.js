    ...
    <div className={commonStyles.container}>
      ...
      <div className={styles.privacyContainer}>
        <p className={styles.text}>
          この利用規約(以下, 「本規約」といいます。)は, RIN(以下, 「当社」といいます。)
          がアプリ上で提供するサービス(以下, 「本サービス」といいます。)の利用条件を定めるものです。
          登録ユーザーの皆さま(以下, 「ユーザー」といいます。)には, 本規約に従って, 本サービスをご利用いただきます。
        </p>

        <p className={styles.label}>第1条(適用)</p>
        ...
        <p className={styles.label}>第2条(利用登録)</p>
        <ol className={styles.text}>
          <li>
        ...
        <p className={styles.label}>第3条(ユーザーIDおよびパスワードの管理)</p>
        <ol className={styles.text}>
          <li>
        ...
        <p className={styles.label}>第4条(利用料金および支払方法)</p>
        <ol className={styles.text}>
          <li>
        ...
        <p className={styles.label}>第5条(禁止事項)</p>
        ...
        <p className={styles.label}>第6条(本サービスの提供の停止等)</p>
        <ol className={styles.text}>
          <li>
        ...
        <p className={styles.label}>第7条(利用期限および登録抹消)</p>
        <ol className={styles.text}>
          <li>
        ...
        <p className={styles.label}>第8条(退会)</p>
        <p className={styles.text}>ユーザーは，当社の定める退会手続により，本サービスから退会できるものとします。</p>

        <p className={styles.label}>第9条(保証の否認および免責事項)</p>
        <ol className={styles.text}>
          <li>
        ...
        <p className={styles.label}>第10条(サービス内容の変更等)</p>
        <p className={styles.text}>当社は，ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。</p>

        <p className={styles.label}>第11条(利用規約の変更)</p>
        <ol className={styles.text}>
          <li>
        ...
        <p className={styles.label}>第12条(個人情報の取扱い)</p>
        <p className={styles.text}>当社は，本サービスの利用によって取得する個人情報については，当社<Link href="/privacy"><span style={{textDecoration:'underline',color:'blue'}}>プライバシーポリシー</span></Link>に従い適切に取り扱うものとします。</p>

        <p className={styles.label}>第13条(通知または連絡)</p>
        <p className={styles.text}>ユーザーと当社との間の通知または連絡は，当社の定める方法によって行うものとします。当社は,ユーザーから,当社が別途定める方式に従った変更届け出がない限り,現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い,これらは,発信時にユーザーへ到達したものとみなします。</p>

        <p className={styles.label}>第14条(権利義務の譲渡の禁止)</p>
        <p className={styles.text}>ユーザーは，当社の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。</p>

        <p className={styles.label}>第15条(準拠法・裁判管轄)</p>
        <ol className={styles.text}>
          <li>
            <p>本規約の解釈にあたっては，日本法を準拠法とします。</p>
          </li>
          <li>
            <p>本サービスに関して紛争が生じた場合には，東京高等裁判所を専属的合意管轄とします。</p>
          </li>
        </ol>
